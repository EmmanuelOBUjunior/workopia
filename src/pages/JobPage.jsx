          ...
          <div className="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
            ...
            <aside>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                ...
                <button onClick={()=>handleDelete(job._id)} className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block">
                  Delete Job
                </button>
              </div>
            </aside>
